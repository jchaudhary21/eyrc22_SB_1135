   ...
   address = 0 ;
	...
	begin
		case (cs)
			...
			else if (address_counter == 5'b100) begin address = 0 ; cs = df_2; end 
			       end 
					 
			df_2 : begin
			if (address_counter == 5'b10) begin address = 0 ;end 
			else if (address_counter == 5'b11) begin address = 0 ; end 
			else if (address_counter == 5'b100) begin address = 1 ; cs = df_3 ;end 
			       end 
					 
			df_3 : begin
			if (address_counter == 5'b10) begin address = 0 ;end 
			else if (address_counter == 5'b11) begin address = 1 ;end 
			else if (address_counter == 5'b100) begin address = 0 ; cs = df_1 ;end 
			      end
